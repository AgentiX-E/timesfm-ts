  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        //     error-handling branches excluded via per-line v8 ignore
        ...
        //
        // A separate "excluded-files coverage" report is generated by the
        // ci-coverage-excluded-check.js script and published to GitHub Pages
        // for transparency.  See docs/coverage/excluded/ for per-file details.
