...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `@agentix-e/timesfm-core`         | [![npm](https://img.shields.io/npm/v/@agentix-e/timesfm-core?color=blue)](https://www.npmjs.com/package/@agentix-e/timesfm-core)                 | Pure TypeScript core: IInferenceEngine abstraction, decode loop, pre/post-processing |
| `@agentix-e/timesfm-node`         | [![npm](https://img.shields.io/npm/v/@agentix-e/timesfm-node?color=blue)](https://www.npmjs.com/package/@agentix-e/timesfm-node)                 | **Node.js** ONNX Runtime inference engine (onnxruntime-node)                         |
